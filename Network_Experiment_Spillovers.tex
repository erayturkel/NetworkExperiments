...
Similarly,we write $c_\infty$ for the cost associated with the final treatment allocation $\pi(\Gamma)$. Hence, the total cost for the decision maker is given by:

$$ c= \sum_{t \leq T} c_t  + c_\infty .$$
